    ...
    <footer class="dashboard-footer">
        <div class="footer-content">
            ...
            <div class="footer-links">
                <a href="https://github.com/mmximxim/vscode-antigravity-cockpit" target="_blank" class="footer-link star-link">
                    ${i18n.t('footer.star')}
                </a>
                <a href="https://github.com/mmximxim/vscode-antigravity-cockpit/issues" target="_blank" class="footer-link feedback-link">
                    💬 ${i18n.t('footer.feedback')}
                </a>
                <a href="https://github.com/mmximxim/vscode-antigravity-cockpit/blob/main/docs/DONATE.md" target="_blank" class="footer-link donate-link">
